...
class RateLimitedSession:
    ...
    def _wait_for_rate_limit(self, url):
        ...
        if elapsed < self.delay:
            ...
            logger.debug(
                f"Rate limiting: Waiting {wait_time:.2f}s before request to {domain}"
            )
    ...
    def get(self, url, **kwargs):
        ...
        try:
            ...
            if (
                ...
                backoff_time = min(self.delay * 2, self.max_delay) * random.uniform(
                    0.8, 1.2
                )
...
class WebCrawler:
    ...
    def extract_links(self, url, html_content):
        ...
        for a_tag in soup.find_all("a", href=True):
            ...
            if is_internal_url(self.base_url, normalized_url) and is_valid_url(
                normalized_url
            ):
